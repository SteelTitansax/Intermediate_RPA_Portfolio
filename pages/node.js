...
import {nodeSkills, reactExperiences, reactProjects, reactNativeProjects, angularProjects, nodeProjects, nocodeProjects} from '../profile'
          ...
          <div className="col-md-12">
                <div className="card card-body bg-primary">
                    <div className="row">
                        ...
                        {
                              nodeProjects.map(({name,description,image,github},i) => (
