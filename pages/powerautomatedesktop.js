...
import {electronSkills, powerappsExperiences, reactProjects, reactNativeProjects, powerAutomateDesktopProjects, nodeProjects, nocodeProjects} from '../profile'
import Link from 'next/link'



const PowerAutomateDesktop = () =>
<>
<Layout>
        ...
        <div className="col-md-12">
            ...
            <div className="row">
                <div className="col-md-2">
                    <img src="powerautomatedesktop.jpg" className="mt-1" height="95px" alt="React perfil"/>
                </div>
                <div className="col-md-10">
                    <h1 >Power Automate Desktop </h1>
                    <h3>RPA Automation Tool</h3> 
                    <h6 style={{paddingTop:'8px'}}>Power Automate Desktop is a part of Microsoft Power Platform as it is a workflow engine that uses the same connectors as in Power Apps to give you access to content for automated processing</h6>
...
export default PowerAutomateDesktop; 
