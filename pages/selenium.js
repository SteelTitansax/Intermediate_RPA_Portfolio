...
import {electronSkills, powerappsExperiences, reactProjects, reactNativeProjects, seleniumProjects, nodeProjects, nocodeProjects} from '../profile'
        ...
        <div className="col-md-12">
            ...
            <div className="row">
                <div className="col-md-2">
                    <img src="selenium.jpg" className="mt-1" height="95px" alt="React perfil"/>
                </div>
                <div className="col-md-10">
                    <h1 >Selenium  </h1>
                    <h3>WebScrapper python lybrary</h3> 
                    <h6 style={{paddingTop:'8px'}}>Selenium is an open source umbrella project for a range of tools and libraries aimed at supporting browser automation.</h6>
                ...
                <div className="card card-body bg-primary">
                    <div className="row">
                        ...
                        <div className="col-md-12 mt-3">
                            <h3 className="text-center text-white"> Selenium</h3>
                            <hr className="bg-white "/>
                        </div>        
                        <div className="col-md-3 p-2" />

                        {
                              seleniumProjects.map(({name,description,image,url},i) => (
