...
import {electronSkills, websiteExperiences, terraformProjects, reactNativeProjects, dockerProjects, nodeProjects, nocodeProjects} from '../profile'
        ...
        <div className="col-md-12">
            ...
            <div className="row">
                <div className="col-md-2">
                    <img src="terraform.jpg" className="mt-1" height="95px" alt="React perfil"/>
                </div>
                <div className="col-md-10">
                    <h1>Terraform</h1>
                    <h3>OS Level Virtualization Software</h3> 
                    <h6 style={{paddingTop:'8px'}}>Terraform is an open-source infrastructure as code software tool that enables you to safely and predictably create, change, and improve infrastructure.</h6>
                ...
                <div className="card card-body bg-primary">
                    <div className="row">
                        ...
                        <div className="col-md-12 mt-3">
                            <h3 className="text-center text-white"> Terraform</h3>
                            <div className="border-bottom"/>
                        </div>        
                        <div className="col-md-3 p-2" />

                        {
                              terraformProjects.map(({name,description,image,url},i) => (
