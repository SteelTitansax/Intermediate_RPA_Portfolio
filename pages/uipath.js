        ...
        <div className="col-md-12">
            ...
            <div className="row">
                <div className="col-md-2">
                    <img src="uipath.jpg" className="mt-1" height="95px" alt="React perfil"/>
                </div>
                <div className="col-md-10">
                    <h1 >UiPath </h1>
                    <h3>RPA Automation Tool</h3> 
                    <h6 style={{paddingTop:'8px'}}>UiPath is a global software company that makes robotic process automation (RPA) software.</h6>
